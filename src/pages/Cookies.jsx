        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-[220px_1fr] gap-12">
          ...
          <aside className="hidden lg:block">
            <nav className="sticky top-28 text-sm space-y-3">
              ...
              <a href="#overview" className="block text-text-secondary hover:text-accent">
                Overview
              </a>

              <a href="#categories" className="block text-text-secondary hover:text-accent">
                Cookie categories
              </a>

              <a href="#nonessential" className="block text-text-secondary hover:text-accent">
                Non-essential cookies
              </a>

              <a href="#preferences" className="block text-text-secondary hover:text-accent">
                Changing preferences
              </a>

              <a href="#information" className="block text-text-secondary hover:text-accent">
                More information
              </a>
            </nav>
          </aside>
          ...
          {/* CONTENT */}
          <div className="bg-card-bg border border-border rounded-xl p-8 shadow-sm space-y-10 text-sm text-text-secondary">
