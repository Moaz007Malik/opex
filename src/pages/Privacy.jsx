      ...
      <Section>
        <div className="max-w-3xl">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-text-secondary text-sm">
            ...
            <section>
              <h2 className="text-lg font-semibold text-text-primary mt-8 mb-2">2. What data we collect</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-text-primary mt-8 mb-2">3. How we use your data</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-text-primary mt-8 mb-2">4. Lawful basis</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-text-primary mt-8 mb-2">5. Who we share data with</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-text-primary mt-8 mb-2">6. International transfers</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-text-primary mt-8 mb-2">7. Data retention</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-text-primary mt-8 mb-2">8. Your rights</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-text-primary mt-8 mb-2">9. ICO complaint route</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-text-primary mt-8 mb-2">10. Cookies</h2>
              <p>
