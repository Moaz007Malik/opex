    ...
    <>
      ...
      <Section>
        ...
        <div className="max-w-4xl mx-auto space-y-8 text-sm">
          ...
          <div className="border border-border rounded-xl p-6 bg-card-bg">
            <h2 className="text-lg font-semibold text-text-primary mb-3">2. Purpose of this site</h2>
            <p className="text-text-secondary">
          ...
          <div className="border border-border rounded-xl p-6 bg-card-bg">
            <h2 className="text-lg font-semibold text-text-primary mb-3">3. No binding offer</h2>
            <p className="text-text-secondary">
          ...
          <div className="border border-border rounded-xl p-6 bg-card-bg">
            <h2 className="text-lg font-semibold text-text-primary mb-3">6. Third-party trade marks</h2>
            <p className="text-text-secondary">
          ...
          <div className="border border-border rounded-xl p-6 bg-card-bg">
            <h2 className="text-lg font-semibold text-text-primary mb-3">7. External links</h2>
            <p className="text-text-secondary">
          ...
          <div className="border border-border rounded-xl p-6 bg-card-bg">
            <h2 className="text-lg font-semibold text-text-primary mb-3">8. No warranty</h2>
            <p className="text-text-secondary">
          ...
          <div className="border border-border rounded-xl p-6 bg-card-bg">
            <h2 className="text-lg font-semibold text-text-primary mb-3">10. Pricing and features</h2>
            <p className="text-text-secondary">
          ...
          <div className="border border-border rounded-xl p-6 bg-card-bg">
            <h2 className="text-lg font-semibold text-text-primary mb-3">12. Changes</h2>
            <p className="text-text-secondary">
