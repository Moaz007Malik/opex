    ...
    <>
      ...
      >
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          <p className="text-text-primary text-2xl max-w-3xl leading-snug">
      ...
      <Section>
        ...
        <div className="max-w-3xl mx-auto space-y-8 text-xl leading-relaxed text-pretty">
          ...
          <div className="border border-border rounded-xl p-6 bg-card-bg">
            <h2 className="text-3xl font-semibold text-text-primary mb-3">2. Purpose of this site</h2>
            <p className="text-text-primary">
          ...
          <div className="border border-border rounded-xl p-6 bg-card-bg">
            <h2 className="text-3xl font-semibold text-text-primary mb-3">3. No binding offer</h2>
            <p className="text-text-primary">
          ...
          <div className="border border-border rounded-xl p-6 bg-card-bg">
            <h2 className="text-3xl font-semibold text-text-primary mb-3">4. Acceptable use</h2>
            <p className="text-text-primary">
          ...
          <div className="border border-border rounded-xl p-6 bg-card-bg">
            <h2 className="text-3xl font-semibold text-text-primary mb-3">5. Intellectual property</h2>
            <p className="text-text-primary">
          ...
          <div className="border border-border rounded-xl p-6 bg-card-bg">
            <h2 className="text-3xl font-semibold text-text-primary mb-3">6. Third-party trade marks</h2>
            <p className="text-text-primary">
          ...
          <div className="border border-border rounded-xl p-6 bg-card-bg">
            <h2 className="text-3xl font-semibold text-text-primary mb-3">7. External links</h2>
            <p className="text-text-primary">
          ...
          <div className="border border-border rounded-xl p-6 bg-card-bg">
            <h2 className="text-3xl font-semibold text-text-primary mb-3">8. No warranty</h2>
            <p className="text-text-primary">
          ...
          <div className="border border-border rounded-xl p-6 bg-card-bg">
            <h2 className="text-3xl font-semibold text-text-primary mb-3">9. Limitation of liability</h2>
            <p className="text-text-primary">
          ...
          <div className="border border-border rounded-xl p-6 bg-card-bg">
            <h2 className="text-3xl font-semibold text-text-primary mb-3">10. Pricing and features</h2>
            <p className="text-text-primary">
          ...
          <div className="border border-border rounded-xl p-6 bg-card-bg">
            <h2 className="text-3xl font-semibold text-text-primary mb-3">11. Governing law</h2>
            <p className="text-text-primary">
          ...
          <div className="border border-border rounded-xl p-6 bg-card-bg">
            <h2 className="text-3xl font-semibold text-text-primary mb-3">12. Changes</h2>
            <p className="text-text-primary">
