    ...
    <>
      ...
      <Section>
        ...
        <div className="max-w-4xl mx-auto space-y-8 text-sm">
          ...
          <div className="border border-black/10 rounded-xl p-6">
            <h2 className="text-lg font-semibold text-black mb-3">2. Purpose of this site</h2>
            <p className="text-black/70">
          ...
          <div className="border border-black/10 rounded-xl p-6">
            <h2 className="text-lg font-semibold text-black mb-3">3. No binding offer</h2>
            <p className="text-black/70">
          ...
          <div className="border border-black/10 rounded-xl p-6">
            <h2 className="text-lg font-semibold text-black mb-3">4. Acceptable use</h2>
            <p className="text-black/70">
          ...
          <div className="border border-black/10 rounded-xl p-6">
            <h2 className="text-lg font-semibold text-black mb-3">6. Third-party trade marks</h2>
            <p className="text-black/70">
          ...
          <div className="border border-black/10 rounded-xl p-6">
            <h2 className="text-lg font-semibold text-black mb-3">7. External links</h2>
            <p className="text-black/70">
          ...
          <div className="border border-black/10 rounded-xl p-6">
            <h2 className="text-lg font-semibold text-black mb-3">8. No warranty</h2>
            <p className="text-black/70">
          ...
          <div className="border border-black/10 rounded-xl p-6">
            <h2 className="text-lg font-semibold text-black mb-3">10. Pricing and features</h2>
            <p className="text-black/70">
          ...
          <div className="border border-black/10 rounded-xl p-6">
            <h2 className="text-lg font-semibold text-black mb-3">11. Governing law</h2>
            <p className="text-black/70">
          ...
          <div className="border border-black/10 rounded-xl p-6">
            <h2 className="text-lg font-semibold text-black mb-3">12. Changes</h2>
            <p className="text-black/70">
